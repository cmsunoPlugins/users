...
if(file_exists('data/_sdata-'.$sdata.'/users.json'))
	...
	<div id="usersBox" class="'.(isset($Uw3['dropdown']['w3-dropdown-content'])?$Uw3['dropdown']['w3-dropdown-content']:'w3-dropdown-content').' '.((isset($Uw3['card']['w3-card'])&&empty($a['c']))?$Uw3['card']['w3-card']:'w3-card').' usersBox w3-hide" style="width:214px;'.$align.':0;'.($color?'background-color:'.$color.';':'').'">
